// ⚠️ DUPLICATE of @chemist/shared/schemas/lab.ts
//
// Vercel build cannot resolve workspace deps from this monorepo, so lab-app
// must stay self-contained (per REDEPLOY.md). Keep this file in sync with
// packages/shared/src/schemas/lab.ts whenever the schema or ROOM_CONFIG
// changes — both are the source of truth (server uses shared/, client uses
// this file).
import { z } from "zod";
