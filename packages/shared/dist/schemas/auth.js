...
export const loginSchema = z.object({
    phone: z
        ...
        .transform((val) => val.replace(/^0/, "62").replace(/^62/, "62").replace(/^\+62/, "62")),
...
export const otpSchema = z
    ...
    password: z
        ...
        .min(8, "Password minimal 8 karakter")
        .max(128, "Password maksimal 128 karakter")
        .regex(passwordRegex, "Password harus mengandung huruf besar, huruf kecil, angka, dan karakter khusus"),
