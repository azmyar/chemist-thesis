...
export const createRangkumanSchema = z
	...
	.refine(
		...
		{
			message:
				"Content MD wajib untuk tipe content, Checkpoint Question ID wajib untuk tipe checkpoint",
			path: ["type"],
		},
	);
...
export type UpdateRangkumanProgressType = z.infer<
	typeof updateRangkumanProgressSchema
>;
